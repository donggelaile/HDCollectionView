...
//默认回调相关--------------------------------------------------------begin
#define HDGetBackModelContext(backModel) (([backModel isKindOfClass:[HDCellModel class]] || [backModel isKindOfClass:[HDSectionModel class]] || [backModel isKindOfClass:[NSDictionary class]])?[backModel valueForKey:@"context"]:nil)
